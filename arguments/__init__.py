...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.train_test_exp = False # use exposure compensation
        self.data_device = "cuda"
        self.eval = False
        self.skip_first = False
        # borrow from EndoGaussian
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.vdgs_type = "both" # opacity | color | both
        self.vdgs_width = 32
        self.vdgs_lr = 0.001
...
class AnchorOptimizationParams(ParamGroup):
    def __init__(self, parser):
        self.iterations = 30_000
        ...
        # for coarse to fine
        self.use_c2f = False
        self.c2f_init_factor = 0.125
        self.c2f_until_iter = 20_000
...
class Scaffold_ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.sh_degree = 3
        self.feat_dim = 32
        self.n_offsets = 10
        ...
        # embed
        # self.use_embbedding = False # True
        # self.add_opacity_embedding = False # True
        # self.add_cov_embedding = False # True
        # self.embed_dim = 10 # not use maybe 
        # self.use_vignetting = False # True
        # self.theta_embed_dim = 10 # used 
        super().__init__(parser, "Loading Parameters", sentinel)
...
class Scaffold_OptimizationParams(ParamGroup):
    def __init__(self, parser):
        self.iterations = 30_000
        self.position_lr_init = 0.0
        self.position_lr_final = 0.0
